(function($) {
  ...
  win.resize(function() {
      ...
      if (w < 890 && !sidebar.hasClass('collapsed')) {
          toggleSidebar();
      } else if (w > 890 && sidebar.hasClass('collapsed')) {
          toggleSidebar();
      }
  });
  ...
  function toggleSidebar() { 
      ...
      if (win.width() < 890 || !sidebar.hasClass('collapsed')) {
          body.animate({'padding-left':'0'},100);
      }
      else if (win.width() > 890 && sidebar.hasClass('collapsed')) {
